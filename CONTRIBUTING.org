...
Please, send a GitHub Pull Request (PR) to [[https://github.com/iWas-Coder/trm][iWas-Coder/trm]] with a clear list of what you've done ([[http://help.github.com/pull-requests/][read more about PRs]]). The best place to start is to fork the repository to your personal profile, and start working from there.
...
For more information, see [[https://github.com/iWas-Coder/trm/blob/master/CODE_OF_CONDUCT.md][CODE_OF_CONDUCT.md]].
